...
catalogItem2 = CatalogItem(name = "The Smell of Data", description = "The sense of smell helped early humans to survive. But now that our hunting and gathering has moved to the digital environment, our noses can no longer warn us of the lurking dangers in the online wilderness. The Smell of Data is a new scent created to instinctively alert internet users of data leaks on personal devices.",
 price = "[To Be Announced]", category = category1)
...
catalogItem3 = CatalogItem(name = "Protection Cut Resistant Sleeves", description = "DuPont Kevlar brand fiber, flexible, cool and comfortable to wear; with designed protection against bites, cuts, and scratches ",
...
catalogItem4 = CatalogItem(name = "Men's Soft Shell Heated Jacket Kit", description = "KEEPS YOU WARM AND COMFORTABLE: Soft shell fabric on the outside make the jacket water and wind resistance but still soft and flexible. The interior has some light insulation with a fleece lining to keep the heat in and the comfort level high.",
...
catalogItem1 = CatalogItem(name = "Yaktrax Walk Traction Cleats", description = "Lightweight and affordable slip-on traction cleats to reduce the risk of falls when walking on snow or ice to work, school, or even to the mailbox",
...
catalogItem4 = CatalogItem(name = "LOTR Fire Pit Eye Tower", description = "ONE OF A KIND very detailed hand made fire-pit from Canada. Approximately 5 foot high and 2 foot wide base made from heavy gauge steel.",
...
catalogItem3 = CatalogItem(name = "Spinx", description = "The first ever toilet cleaning robot. With amazing design, through cleanliness, you'll never have to clean a toilet again.",
...
catalogItem1 = CatalogItem(name = "The Infrared Supine Sauna", description = "The Infrared Supine Sauna is a personal sauna that uses an array of tiny infrared lights to penetrate deeply into aching tissue. It's also full of jade stones, which have some kind of application in traditional Chinese medicine.",
 price = "$14,000", category = category5)

session.add(catalogItem1)
session.commit()

catalogItem2 = CatalogItem(name = "Scorkl", description = "Scorkl is lightweight, portable, refillable via hand pump and gives you up to 10min underwater",
 price = "$398", category = category5)

session.add(catalogItem2)
session.commit()

catalogItem3 = CatalogItem(name = "GameSir G5", description = "GameSir G5 is the revolutionary gamepad designed for MOBA and first/third person shooting mobile games. iOS and Android compatible.",
